...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home | Ted’s Tasty Taco Truck </title>
...
<body class="home">
        ...
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    ...
                    <li class="nav-item"> <a class="nav-link active" href="dishes.php">
                        <img  src="images/profile.png" alt="" width="8%">
                        ...
                        <li class="nav-item"> <a class="nav-link active" href="cart.php">
                            <img  src="images/cart.png" alt="" width="8%">
                         <span class="sr-only"></span></a> </li>
    ...
    <section class="popular">
        <div class="container">
            ...
            <div class="row">
            <?php
                $query = $pdo->query("SELECT * FROM dishes LIMIT 6");
