...
<body>
    ...
    <!-- <div class="page-wrapper"> -->
        <div class="top-links">
            ...
            <?php
            $stmt = $pdo->prepare("SELECT * FROM restaurant WHERE rs_id = :rs_id");
            $stmt->execute(['rs_id' => $_GET['res_id']]);
                    ...
                    <div class="widget widget-cart">
                        ...
                        <div class="order-row bg-white">
                            ...
                            foreach ($_SESSION["cart_item"] as $item) {
                                ...
                                $stmt = $pdo->prepare("SELECT * FROM dishes WHERE d_id=:d_id");
                                $stmt->bindValue(":d_id", $item["d_id"]);
                                $stmt->execute();
                            ...
                            ?>
                                ...
                                <div class="form-group row no-gutter">
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control b-r-0" value=<?php echo "$".$dish["price"]; ?> readonly id="exampleSelect1">
                                    </div>
                                    <div class="col-xs-4">
                        ...
                        <div class="price-wrap text-xs-center">
                            ...
                            if($item_total == 0){
                                ...
                                $action = 'check';
                                ?>
                                <a href="checkout.php?res_id=<?php echo $res_id ?>&action=<?php echo $action ?>" class="btn btn-danger btn-lg disabled">Checkout</a>
                                <?php
                            } else {
                                $res_id = $_GET['res_id'];
                                $action = 'check';
                                ?>
                                <a href="checkout.php?res_id=<?php echo $res_id ?>&action=<?php echo $action ?>" class="btn btn-success btn-lg active">Checkout</a>
                                <?php
                            }
                            ?>
                        </div>
